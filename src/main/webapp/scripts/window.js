		...
		renderUI: function(){
			...
			switch(this.cfg.winType){
				case "alert":
					...
					break;
				case "confirm":
					footerContent = '<input type="button" value="' + this.cfg.text4ConfirmBtn + '" class="window_confirmBtn btn-red'+this.cfg.confirmBtnClass+' btn " /><input type="button" value="' + this.cfg.text4CancelBtn + '" class="window_cancelBtn btn btn-default" />';
					break;
				default:
					break;
			}
